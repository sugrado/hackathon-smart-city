...
function Profile({ handleLogOut }) {
   ...
   useEffect(() => {
      ...
      axios
         .get(
            `https://6f2d-46-154-111-77.eu.ngrok.io/api/WasteRecords/GetUserCategoryStatistics/${localStorage.getItem(
               "userIdentity"
            )}`
         )
               ...
               <div className="w-1/3 pr-4 pb-4">
                  <div className=" w-full h-full shadow-md flex flex-col ">
                     <div className="flex flex-col text-center pb-2 mt-5 px-2 text-xl font-bold">
                        <span>Kağıt</span>
                        <span>
                           Toplam Atık Miktarı : {wastes && wastes[0]?.quantity}{" "}
                           kg
                        </span>
                     </div>
               ...
               <div className="w-1/3 pr-4 pb-4">
                  <div className=" w-full h-full shadow-md flex flex-col ">
                     <div className="flex flex-col text-center pb-2 mt-5 px-2 text-xl font-bold">
                        <span>Cam</span>
                        <span>
                           Toplam Atık Miktarı : {wastes && wastes[1]?.quantity}{" "}
                           kg
                        </span>
                     </div>
                     <div className="w-full h-3/4">
               ...
               <div className="w-1/3 pr-4 pb-4">
                  <div className=" w-full h-full shadow-md flex flex-col ">
                     <div className="flex flex-col text-center pb-2 mt-5 px-2 text-xl font-bold">
                        <span>Metal</span>
                        <span>
                           Toplam Atık Miktarı : {wastes && wastes[2]?.quantity}{" "}
                           kg
                        </span>
                     </div>
                     <div className="w-full h-3/4">
               ...
               <div className="w-1/3 pr-4 pb-4">
                  <div className=" w-full h-full shadow-md flex flex-col ">
                     <div className="flex flex-col text-center pb-2 mt-5 px-2 text-xl font-bold">
                        <span>Kompost</span>
                        <span>
                           Toplam Atık Miktarı : {wastes && wastes[3]?.quantity}{" "}
                           kg
                        </span>
                     </div>
                     <div className="w-full h-3/4">
               ...
               <div className="w-1/3 pr-4 pb-4">
                  <div className=" w-full h-full shadow-md flex flex-col ">
                     <div className="flex flex-col text-center pb-2 mt-5 px-2 text-xl font-bold">
                        <span>Plastik</span>
                        <span>
                           Toplam Atık Miktarı : {wastes && wastes[4]?.quantity}{" "}
                           kg
                        </span>
                     </div>
                     <div className="w-full h-3/4">
               ...
               <div className="w-1/3 pr-4 pb-4">
                  <div className=" w-full h-full shadow-md flex flex-col ">
                     <div className="flex flex-col text-center pb-2 mt-5 px-2 text-xl font-bold">
                        <span>Kağıt</span>
                        <span>
                           Toplam Atık Miktarı : {wastes && wastes[5]?.quantity}{" "}
                           kg
                        </span>
                     </div>
                     <div className="w-full h-3/4">
